...
`cordova plugin add https://github.com/chroa/twitter-connect-plugin  --variable TWITTER_KEY=value --variable TWITTER_SECRET=value --variable FABRIC_KEY=<Fabric API Key>`
